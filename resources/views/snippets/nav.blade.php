            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="https://www.facebook.com/UnderdogsGaming"><i class="fa fa-facebook"></i></a>
                        </li>
                        <li>
                            <a href="https://plus.google.com/+UnderdogsImFC"><i class="fa fa-google-plus"></i></a>
                        </li>
                        <li>
                            <a href="https://www.youtube.com/user/TheUnderdogsGuild"><i class="fa fa-youtube"></i></a>
                        </li>
                        <li>
                            <a href="https://twitter.com/UnderdogsGuild"><i class="fa fa-twitter"></i></a>
                        </li>
                        @if (Auth::guest())
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                @if(\App\Services\PermissionsService::canString('home_controller_at_index'))
                                    <li><a href="/admin">{{ \Auth::user()->roles()->first()->pretty_name }} Dashboard</a></li>
                                @endif
